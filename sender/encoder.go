...
// NeedsNVMMMemory returns true if the encoder requires video/x-raw(memory:NVMM) input
func NeedsNVMMMemory(encoder EncoderType) bool {
	switch encoder {
	case NVV4L2H264Enc, NVV4L2H265Enc, NVV4L2VP8Enc, NVV4L2VP9Enc:
		return true
	}
	return false
}
